...
const servizi = [
  ...
  },
  {
    ...
    slug: 'PIEGATURA',
    title: 'Piegatura',
    body: 'Piegatura su 5 presso-piegatrici fino a 750 tonnellate di potenza su 7 metri. Riusciamo ad eseguire piegati fino a 13 metri di lunghezza. Capacità di piegare lamiera 15 mm per lunghezze fino a 5,3 metri con precisione assoluta.',
    specs: 'Presso-piegatrici: 5 unità, Potenza max: 750 ton su 7 m, Lunghezza max pieghe: 13 m, Spessore max: 15 mm',
